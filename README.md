...
<title>Harsh — GitHub Profile</title>
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .avatar-inner {
    ...
    color: var(--cyan);
    letter-spacing: 1px;
    text-shadow: 0 0 24px rgba(0,247,255,0.6);
  }
  .hero-name {
    font-size: 38px;
    font-weight: 600;
  ...
  .pill-cyan   { background: rgba(0,247,255,0.07);   border-color: rgba(0,247,255,0.25);   color: #00d4db; }
  .pill-purple { background: rgba(164,139,232,0.1);  border-color: rgba(164,139,232,0.3);  color: var(--purple); }
  .pill-green  { background: rgba(61,207,116,0.08);  border-color: rgba(61,207,116,0.25);  color: var(--green); }
  .pill-orange { background: rgba(255,146,64,0.09);  border-color: rgba(255,146,64,0.28);  color: var(--orange); }
  ...
  .do-card:hover { border-color: var(--border2); transform: translateY(-3px); }
  .do-card-accent {
  ...
  .do-card-icon  { font-size: 24px; margin-bottom: 10px; }
  .do-card-title { font-size: 13px; font-weight: 600; margin-bottom: 6px; color: var(--text); }
  .do-card-desc  { font-size: 12px; color: var(--text2); line-height: 1.65; }
  ...
  .tech-badge:hover { border-color: var(--border2); transform: translateY(-2px); }
  .tech-dot { width: 7px; height: 7px; border-radius: 50%; flex-shrink: 0; }
  .tech-note { margin-top: 12px; font-size: 11px; color: var(--text3); font-style: italic; }

  /* ── Building section ── */
  .build-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(190px, 1fr)); gap: 10px; }
  .build-item {
    display: flex; align-items: center; gap: 12px;
    background: var(--bg2);
    border-radius: var(--radius-md);
  ...
  .build-item:hover { background: var(--bg3); border-color: var(--border2); }
  .build-icon {
  ...
  .stats-block img { max-width: 100%; border-radius: var(--radius-md); }
  .stats-row {
    display: flex; flex-wrap: wrap; gap: 12px;
    justify-content: center; margin-top: 14px;
  }
  .stats-row img { border-radius: var(--radius-md); height: 130px; }
  ...
  .connect-btn:hover { background: var(--bg3); border-color: rgba(255,255,255,0.25); transform: translateY(-2px); }
  ...
  .footer-wave { width: 100%; height: 60px; }
  .footer-wave path { stroke: var(--cyan); stroke-width: 1.5; fill: none; }
  .footer-text {
...
<div class="readme">
  ...
  <div class="hero">
    ...
    <div class="avatar-ring">
      <svg class="avatar-svg" width="110" height="110" viewBox="0 0 110 110">
        <circle cx="55" cy="55" r="48" fill="none" stroke="rgba(0,247,255,0.12)" stroke-width="1"/>
        <circle cx="55" cy="55" r="48" fill="none" stroke="#00f7ff" stroke-width="1.5"
          stroke-dasharray="9 7" stroke-linecap="round"/>
        <circle cx="55" cy="7"  r="3.5" fill="#00f7ff" opacity="0.85"/>
        <circle cx="103" cy="55" r="2.5" fill="#00f7ff" opacity="0.5"/>
        <circle cx="55" cy="103" r="2" fill="#00f7ff" opacity="0.3"/>
      </svg>
  ...
  <div class="section reveal">
    ...
    <p class="tech-note">HTML/CSS? I can tweak it. For serious frontend, AI helps me — no shame in that.</p>
  </div>
  ...
  <div class="section reveal">
    ...
    <div class="stats-block">
      ...
      <div class="stats-row">
        <img src="https://github-profile-summary-cards.vercel.app/api/cards/stats?username=AtomXHarshYT&theme=tokyonight" alt="Stats" />
        <img src="https://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=AtomXHarshYT&theme=tokyonight&utcOffset=5.5" alt="Productive time" />
        <img src="https://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=AtomXHarshYT&theme=tokyonight" alt="Repos per language" />
        <img src="https://github-profile-summary-cards.vercel.app/api/cards/most-commit-language?username=AtomXHarshYT&theme=tokyonight" alt="Most commit language" />
      </div>
    </div>
  </div>
  ...
  <div class="section reveal">
    ...
    <div class="connect-row">
      ...
      <a class="connect-btn" href="https://github.com/AtomXHarshYT" target="_blank">
  ...
  <div class="footer">
    <svg class="footer-wave" viewBox="0 0 860 60" preserveAspectRatio="none">
      <path d="M0,30 C120,55 200,5 320,30 S500,55 640,30 S780,5 860,30" opacity="0.35"/>
      <path d="M0,40 C100,20 220,55 360,35 S520,10 660,40 S780,55 860,30" opacity="0.18"/>
    </svg>
...
<script>
  // Typing animation
  const phrases = ['Backend Developer','Problem Solver','AI-Assisted Coder','Building Real Things'];
